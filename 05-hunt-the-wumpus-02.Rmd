...
I would recommend implementing the code in a separate cell without function header. Once it works, you can indent it and add the function header. Test it, to see that it works reliably.
::: {.infobox .program}
