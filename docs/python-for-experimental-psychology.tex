...
\begin{verbatim}
## <generator object iterator_fun at 0x00000000134FBA98>
\end{verbatim}
...
\hypertarget{game-context}{%
\chapter{Game Context}\label{game-context}}
...
\hypertarget{working-with-tables-via-pandas}{%
\section{Working with tables via Pandas}\label{working-with-tables-via-pandas}}

\hypertarget{single-context-to-rule-them-all}{%
\section{Single context to rule them all}\label{single-context-to-rule-them-all}}
