...
Next, use `Apple` class for the apple and adjust the code accordingly using attributes and `draw()` method. Here, you have to do all alterations in one go, of course, as we changes we introduced are breaking.
