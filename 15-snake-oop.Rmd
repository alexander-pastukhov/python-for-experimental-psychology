...
We still want the window to behave like PsychoPy window, so our `GridWindow` will inherit from it. Create a new file _gridwindow.py_ and put in the class declaration line where `GridWindow` should descend from `Window` from `psychopy.visual`. Think about imports that you require.
