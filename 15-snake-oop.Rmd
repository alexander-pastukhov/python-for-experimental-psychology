...
We still want the window to behave like PsychoPy window, so our `GridWindow` will inherit from it. Create a new file _gridwindow.py_ and put in the class declration line (the one with `def`.
