...
This time most of the changes we will be in classes, so making versions of them will be quite cumbersome. Thus, submit only the final game. I would suggest calling files _main.py_ (main script), _moonlander.py_ (`MoonLander` class), and _landingpad.py_ (`LandingPad` class).
