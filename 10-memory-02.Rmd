...
You can of course combine the transformation and filtering in a single statement. In a Jupyter cell, create code that filters out all items below 2 and adds 4 to them.
